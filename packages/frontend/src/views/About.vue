<template>
  <div class="about-container">
    <!-- Header Section -->
    <header class="header">
      <h1 class="title">关于 EasyEdgeVoice</h1>
      <p class="subtitle">智能TTS语音合成及管理方案</p>
    </header>
    ...
    <section class="intro">
      <div class="intro-content">
        ...
        <p>
          EasyEdgeVoice
          是一个开源工具，致力于将文本轻松转换为自然流畅的语音输出，特别适合短视频语音配音、合成及字幕，长篇文章的有声化需求。
        </p>
      </div>
    </section>
    ...
    <section class="team">
      ...
      <div class="team-content">
        ...
        <p>EasyEdgeVoice 是一个实验性的项目，旨在提供简单高效的语音转换体验。</p>
        <p>喜欢我就给我Star吧</p>
        <div class="links">
          <el-button round plain @click="goToAuthorGitHub">
            <el-icon><Github /></el-icon> geekleecs
          </el-button>
          <el-button type="primary" round plain @click="goToProjectGitHub">
            <el-icon><Github /></el-icon> EasyEdgeVoice
          </el-button>
        </div>
      </div>
    </section>
...
const goToAuthorGitHub = () => {
  window.open("https://github.com/geekleecs", "_blank");
};

const goToProjectGitHub = () => {
  window.open("https://github.com/geekleecs/easyEdgeVoice", "_blank");
};
</script>
